(function () {
	...
	rl.on("line", input => {
		...
		initProcess.steps !== initProcess.questions.length && console.log("\x1b[33m%s\x1b[0m", "You closed the program too earlier your package.json file is not completed");
	});
})();
